        ...
        Speech.prototype.start = function () {
            ...
            if (this.isMicSource) {
                ...
                (navigator).getUserMedia({
				    ...
				    _this.speechEvents.on('stopped_speaking', () => {
				      console.log('stopped_speaking');
				    });

                    _this.sendInterval = setInterval(function() {
                        Platform.getCU().done(function (cu) {
                            cu.send(false);
                        });
                    }, 3000);

				    _this.speechEvents.on('volume_change', (vol, threshold) => {
...
<<<<<<< 0ff1d418012134e8a2981ce0555c541bd2611523
=======
            console.log(text);
            $('#mic-output').text(text);
>>>>>>> Mic stuff mostly done
            var task = new Task();
            var request = new XMLHttpRequest();
            request.open('GET', [
